        ...
        <div className="bg-white dark:bg-[#1a2f44] rounded-xl p-6 border border-gray-200 dark:border-white/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="text-xs text-[#213B54] dark:text-[#C9A7E3] hover:underline">
                ลืมรหัสผ่าน?
              </Link>
            </div>
            ...
            <Button
              type="submit"
              className="w-full bg-[#213B54] hover:bg-[#1a2f44] text-white py-5 text-sm"
              disabled={isLoading}
            >
          ...
          <p className="text-center mt-5 text-gray-500 dark:text-white/60 text-sm">
            ยังไม่มีบัญชี?{' '}
            <Link to="/register" className="text-[#213B54] dark:text-[#C9A7E3] font-medium hover:underline">
              สร้างบัญชี
            </Link>
          </p>
        </div>
