...
1. สรุปเนื้อหาให้สั้นกระชับ โดยรักษาใจความสำคัญของข้อความต้นฉบับ ไม่เกิน 2-3 ประโยค
2. ห้ามแปลความหมายหรือเปลี่ยนคำให้ผิดเพี้ยนจากเดิม ให้คงคำสำคัญและความหมายเดิมไว้
3. ดึงคำสำคัญ (Keywords) ที่เป็นคำหลักในข้อความออกมา 3-5 คำ

ตอบในรูปแบบ JSON เท่านั้น:
{
  "summary": "ข้อความสรุปที่รักษาใจความสำคัญจากต้นฉบับ",
